...
class righthere_css_editor {
	...
	function enqueue_styles_and_scripts(){
		rh_enqueue_script( 'bootstrap', $this->url.'bootstrap/js/bootstrap.js', array(),'2.3.1', $this->bootstrap_in_footer);
		
		wp_enqueue_style( 'bootstrap', 	$this->url.'bootstrap/css/namespaced.bootstrap.css', array(), '2.3.1');
		wp_enqueue_style( 'minicolors', 	$this->url.'css/jquery.miniColors.css', array(), '1.0.1');
		wp_enqueue_style( 'rh-css-edit', 	$this->url.'css/style.css', array(), '1.0.0.1');
		
		wp_enqueue_script( 'jquery' );
		wp_enqueue_script( 'tinycolor', 			$this->url.'js/tinycolor.js', array(), '1.0.1' );
		wp_enqueue_script( 'minicolors', 			$this->url.'js/jquery.miniColors.js', array(), '1.0.0' );
		wp_enqueue_script( 'rh-css-scripts', 		$this->url.'js/scripts.js', array(), '1.0.1' );
		wp_enqueue_script( 'rh-css-normalizers', 	$this->url.'js/rhl_css_normalizers.js', array(), '1.0.1' );
		wp_enqueue_script( 'rh-css-actions',	 	$this->url.'js/editor_actions.js', array(), '1.0.1' );
		wp_enqueue_script( 'rh-css-edit', 			$this->url.'js/rhl_css_edit.js', array('tinycolor','rh-css-normalizers','rh-css-actions'), '1.0.1.1' );
		wp_enqueue_script( 'jquery-fontSelector',	$this->url.'js/jquery.fontSelector.js', array(), '1.0.0' );
		//wp_enqueue_script( 'jquery-rule', 					$this->url.'js/jquery.rule-1.0.2-min.js', array(), '1.0.2' );
		wp_enqueue_script( 'jquery-rule', 					$this->url.'js/jquery.rule-1.0.2-dev.js', array(), '1.0.2' );
		//wp_enqueue_script( 'css-jss', 					$this->url.'js/jss.js', array(), '0.0.3' );
	}
...
?>
<div class="rh-css-edit rh-css-edit-form <?PHP echo implode(' ',$class)?>">
