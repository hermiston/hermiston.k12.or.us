	...
	*/
	...
	$goodlayers_element = array(
		...
		'gdl_panel_slider' => array(
			...
			__('PERSONNEL BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_background', 'default'=>'#f7f7f7'),
			__('PERSONNEL POSITION TEXT', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_position_text', 'default'=>'#9d9d9d'),
			__('PERSONNEL TITLE', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_title', 'default'=>'#353535'),
			__('PERSONNEL THUMBNAIL BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_thumbnail_border', 'default'=>'#ef7f2c'),
			__('PERSONNEL CONTENT', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_content', 'default'=>'#838383'),			
			__('PERSONNEL WIDGET INFO', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_widget_info', 'default'=>'#4a4a4a'),				
		),
